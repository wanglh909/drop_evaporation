...
module front_mod
  use kind, only: rk, ik
  use omp_lib
  use data, only: NV=>NVar, NN=>NTN, iBW, rNOP, NE=>NTE, NOP=>globalNM, MDF, NOPP, s_mode, load=>dsol, NEL, NEM, ths, bas
  ...
  integer(kind=ik) :: NB, LT_l, m2, m1, mDM, rad_ele, z_ele, iDM, ths2, ths3, ptn_g, ptn2_g, NSi,&
       prm, prm2, max_prs, piv(ths), s_frac, f_cut
  real(kind=rk) :: tr
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!USER_SPECIFIED!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine multifront2(L2res,t)
    ...
    integer(kind=ik) :: iPg(iBW,iDM), jPg(iBW,iDM), fs(iDM), e_n(4,ths), &
         i, j, k, l_i, id, o, p, f1, f2, f3, l_i2, l_i3, s_stop, thsb, sec
    ...
    !$omp parallel do private(f1,f2,f3,i,j,k,id,l_i,l_i2) num_threads(2)
    do sec = 1, 2, 1
       if (sec.eq.1) then
          f1 = s_frac
          f2 = INT((1.0_rk+1.0_rk/tr)*REAL(f1,rk),ik) + f1
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!PHASE 3.0!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine elim_summed(front,loadf,loadf_dum,iPg,jPg,rvs,cvs,RSUM,CSUM,l_i,fs,id,ele)
    ...
    do i = 1, elim, 1
       ...
       !          !if (id.eq.1) call write_solution('test',1,1,1,0)
       !          pause
       !       end if
       !    end do
       ! end do
